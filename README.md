...
```bash
# Em uma nova pasta, para criar um novo projeto:
npm init -y
...
# Agora criamos um arquivo .gitignore com o conteúdo 'node_modules/'
# Bash:
...
# Por fim, criamos a pasta source (fonte) e o arquivo index.js
# Bash:
mkdir src
touch src/index.js
...
// 6) Por fim, devemos declarar a porta de entrada do nosso servidor,
